...
class ClientResourceIT {
    ...
    public static Client createEntity() {
        return new Client().name(DEFAULT_NAME).lastName(DEFAULT_LAST_NAME).mobile(DEFAULT_MOBILE);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client().name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).mobile(UPDATED_MOBILE);
    }
    ...
    @Test
    @Transactional
    void getAllClientsByMobileIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where mobile equals to
        defaultClientFiltering("mobile.equals=" + DEFAULT_MOBILE, "mobile.equals=" + UPDATED_MOBILE);
    }

    @Test
    @Transactional
    void getAllClientsByMobileIsInShouldWork() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where mobile in
        defaultClientFiltering("mobile.in=" + DEFAULT_MOBILE + "," + UPDATED_MOBILE, "mobile.in=" + UPDATED_MOBILE);
    }

    @Test
    @Transactional
    void getAllClientsByMobileIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where mobile is not null
        defaultClientFiltering("mobile.specified=true", "mobile.specified=false");
    }

    @Test
    @Transactional
    void getAllClientsByMobileContainsSomething() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where mobile contains
        defaultClientFiltering("mobile.contains=" + DEFAULT_MOBILE, "mobile.contains=" + UPDATED_MOBILE);
    }

    @Test
    @Transactional
    void getAllClientsByMobileNotContainsSomething() throws Exception {
        // Initialize the database
        insertedClient = clientRepository.saveAndFlush(client);

        // Get all the clientList where mobile does not contain
        defaultClientFiltering("mobile.doesNotContain=" + UPDATED_MOBILE, "mobile.doesNotContain=" + DEFAULT_MOBILE);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).mobile(UPDATED_MOBILE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.mobile(UPDATED_MOBILE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME).mobile(UPDATED_MOBILE);
