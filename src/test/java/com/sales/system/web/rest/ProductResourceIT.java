...
class ProductResourceIT {
    ...
    @Test
    @Transactional
    void getAllProductsByCreationDateIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedProduct = productRepository.saveAndFlush(product);

        // Get all the productList where creationDate equals to
        defaultProductFiltering("creationDate.equals=" + DEFAULT_CREATION_DATE, "creationDate.equals=" + UPDATED_CREATION_DATE);
    }

    @Test
    @Transactional
    void getAllProductsByCreationDateIsInShouldWork() throws Exception {
        // Initialize the database
        insertedProduct = productRepository.saveAndFlush(product);

        // Get all the productList where creationDate in
        defaultProductFiltering(
    ...
    @Test
    @Transactional
    void getAllProductsByCreationDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedProduct = productRepository.saveAndFlush(product);

        // Get all the productList where creationDate is not null
        defaultProductFiltering("creationDate.specified=true", "creationDate.specified=false");
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).category(UPDATED_CATEGORY).creationDate(UPDATED_CREATION_DATE);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.category(UPDATED_CATEGORY);
